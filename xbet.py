...
class _XbetParameters:
    def __init__(self):
        ...
        self.buttons = {
            'login': '#fLogin2 > div > div > div > div.curloginDropTop',
            'logout_1': '#loginout > span.wrap_lk > a:nth-child(2) > span',
            'logout_2': ''
        }
        self.other = {
            'login_status': '#loginout > span.wrap_lk > a:nth-child(1) > span',
        ...
        self.urls = {
            'host': 'https://www.1xbet.com/lt/',
            'timer': 'https://1xbet2.betgames.tv/ext/game/ping/1xbet/4',
            'bet': 'https://1xbet2.betgames.tv/ext/client/accept_bet_ajax/1xbet/',
            'neutral': 'https://www.1xbet.com/lt/tvgames/betgames/'
        }


class Xbet(Thread, SeleniumDrive, _XbetParameters):

    # Constructor & destructor
    def __init__(self, drive_name='', bet_size='', bets_allowed=0, max_login_times=0, odd_1=0, odd_2=0):
        _XbetParameters.__init__(self)
