...
class _TonyParameters:
    def __init__(self):
        ...
        self.buttons = {
            'live_lottery': '#navbar-collapse-menu > ul.nav.navbar-nav.navbar-right > li:nth-child(3) > a',
            'dice': '#lottery_link_4 > a > span',
            'logout': '#navbar-collapse-acc > div > span.sep.pull-right.hidden-xs.hidden-sm > a',
            'filter': '#filter_button',
            'bet_history': '#navbar-collapse-menu > ul.nav.navbar-nav.navbar-right'
                           ' > li.dropdown.active > ul > li:nth-child(3) > a'
        }
        self.other = {
            'login_status': '#navbar-collapse-acc > div > span:nth-child(2) > div.btn-group.popover-check > button',
        ...
        self.urls = {
            ...
            'timer': 'https://tb.betgames.tv/ext/game/ping/tonybet/4',
            'bet': 'https://tb.betgames.tv/ext/client/accept_bet_ajax/tonybet/',
            'neutral': 'https://tonybet.com/betgamestv'
        }


class TonyBet(Thread, SeleniumDrive, _TonyParameters):

    # Constructor & destructor
    def __init__(self, drive_name='', bet_size='', bets_allowed=0, max_login_times=0, odd_1=0, odd_2=0):
        _TonyParameters.__init__(self)
